...
#define HSYNC_LEN 44
#define VSYNC_LEN 5
#define PIXCLOCK  (1000000000/((XRES+LEFT_M+RIGHT_M+HSYNC_LEN)*(YRES+UPPER_M+LOWER_M+VSYNC_LEN)*REFRESH))
  {
    "1920x1080", REFRESH, XRES, YRES, PIXCLOCK, LEFT_M, RIGHT_M, UPPER_M, LOWER_M, HSYNC_LEN, VSYNC_LEN,
    FB_SYNC_OE_ACT_HIGH|FB_SYNC_CLK_SEL_EN|FB_SYNC_CLK_INVERT|FB_SYNC_CLK_IDLE_EN|FB_SYNC_VERT_HIGH_ACT|FB_SYNC_HOR_HIGH_ACT, FB_VMODE_NONINTERLACED, 0
  },
};
