...
static /* const */ DEVICE_ATTR(direction, 0777,
...
static DEVICE_ATTR(edge, 0777, gpio_edge_show, gpio_edge_store);
...
static DEVICE_ATTR(active_low, 0777,
