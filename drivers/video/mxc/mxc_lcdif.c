...
#define HSYNC_LEN 44
#define VSYNC_LEN 5
#define PIXCLOCK  (1000000000/((XRES+LEFT_M+RIGHT_M+HSYNC_LEN)*(YRES+UPPER_M+LOWER_M+VSYNC_LEN)*60))
  {
    "1080P", REFRESH, XRES, YRES, PIXCLOCK, LEFT_M, RIGHT_M, UPPER_M, LOWER_M, HSYNC_LEN, VSYNC_LEN,
		FB_SYNC_HOR_HIGH_ACT | FB_SYNC_VERT_HIGH_ACT,
		FB_VMODE_NONINTERLACED , 0,
  },
#define P720PREFRESH 60
#define P720PXRES 1280
#define P720PYRES 720
#define P720PLEFT_M 220
#define P720PRIGHT_M 110
#define P720PUPPER_M 20
#define P720PLOWER_M 5
#define P720PHSYNC_LEN 40
#define P720PVSYNC_LEN 5
#define P720PPIXCLOCK  (1000000000/((P720PXRES+P720PLEFT_M+P720PRIGHT_M+P720PHSYNC_LEN)*(P720PYRES+P720PUPPER_M+P720PLOWER_M+P720PVSYNC_LEN)*60))
  {
    "720P", P720PREFRESH, P720PXRES, P720PYRES, P720PPIXCLOCK, P720PLEFT_M, P720PRIGHT_M, P720PUPPER_M, P720PLOWER_M, P720PHSYNC_LEN, P720PVSYNC_LEN,
		FB_SYNC_HOR_HIGH_ACT | FB_SYNC_VERT_HIGH_ACT,
		FB_VMODE_NONINTERLACED , 0,
  },
#endif
